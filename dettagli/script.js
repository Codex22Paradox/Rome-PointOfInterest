...
const array = [
  {
    ...
    immagini: [
      "https://i.postimg.cc/Hs5f5t4B/Colosseo.jpg",
      "https://i.postimg.cc/8kF8kGF8/Colosseo2.jpg",
      "https://i.postimg.cc/8zSxbrZD/Colosseo3.jpg",
      "https://i.postimg.cc/Z0kx4pWq/Colosseo4.webp",
    ],
    lonLat: [12.492231, 41.89021],
...
const centro = array[0].lonLat; //coordinate Roma
...
dettagliTitolo.innerHTML = createTitle(array[0]);
dettagliTesto.innerHTML = createDetails(array[0]);

const dettagliImmagini = document.getElementById("dettagliImmagini");
dettagliImmagini.innerHTML = createCarousel(array[0]);
